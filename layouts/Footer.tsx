		...
		<footer className="bg-surface-container-lowest dark:bg-surface-container-lowest border-t-2 border-primary w-full py-md px-lg">
			<div className="max-w-300 mx-auto flex flex-col md:flex-row justify-between items-center gap-md">
				...
				<div className="flex gap-md items-center">
					{/* Ikon GitHub */}
					<a
						className="text-primary hover:text-secondary-container transition-colors duration-200"
					...
					<a
						className="text-primary hover:text-secondary-container transition-colors duration-200"
						href="mailto:aribdmn.dev@gmail.com?subject=Web%20Development%20Inquiry&body=Hi%20Ariyanto%2C%0A%0A%5BPlease%20tell%20me%20how%20I%20can%20help%20you%5D"
